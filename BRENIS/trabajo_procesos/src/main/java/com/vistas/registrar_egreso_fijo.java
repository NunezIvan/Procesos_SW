...
public class registrar_egreso_fijo extends javax.swing.JFrame {
    ...
    public registrar_egreso_fijo(encargado encargadoingresado, Periodo periodoingresado) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " Limpieza", " Luz", " Mantenimiento" }));
    ...
    private void confirmar_panelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmar_panelMouseClicked
        ...
        if (fecha.isEmpty() || montoStr.isEmpty()) {
        ...
        egreso nuevoEgreso = new egreso("Fijo", tipoEgreso, modoPago, null, diaEgreso, mesEgreso, anoEgreso, monto, idPeriodo, encargadoDNI);
