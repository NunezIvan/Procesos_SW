 ...
 * @author USER
 */
public class Registro_Egreso extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AGREGAR EGRESO");
    ...
    private void guardar_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar_buttonActionPerformed
        if (jTextField1.getText().trim().isEmpty() || // Tipo de Pago
            jTextField2.getText().trim().isEmpty() || // Nombre
            jTextField3.getText().trim().isEmpty() || // Día
            jTextField4.getText().trim().isEmpty() || // Mes
            jTextField5.getText().trim().isEmpty() || // Año
            jTextField6.getText().trim().isEmpty() || // Descripción
            ...
            try {
                ...
                egreso nuevoEgreso = new egreso("No_Fijo",tipoPago, nombre,dia,mes,year,descripcion,monto,encargadoDNI);
                ...
                JOptionPane.showMessageDialog(this, "Por favor, ingrese valores válidos para día, mes, año y monto.", "Error de formato", JOptionPane.ERROR_MESSAGE);
            }
        }
