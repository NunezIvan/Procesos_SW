 ...
 * @author USER
 */
public class Modificar_Egreso_Fijo extends javax.swing.JPanel {
    
    private JDialog dialog;
    private egreso egresoSeleccionado;
    
    
    public Modificar_Egreso_Fijo(egreso egresoSeleccionado) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODIFICAR EGRESO FIJO");
    ...
    void cargarDatosEnCampos() {
        jTextField2.setText(egresoSeleccionado.getTipo_egreso());
        jTextField6.setText(egresoSeleccionado.getTipo_pago());
    ...
    private void guardar_button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar_button1ActionPerformed
        ...
        try {
            ...
            egresoSeleccionado.setTipo_egreso(tipo);
            ...
            if (modificarEgreso(egresoSeleccionado)) {
                    JOptionPane.showMessageDialog(this, "Egreso fijo modificado exitosamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "Ocurrió un error al modificar el egreso fijo.", "Error", JOptionPane.ERROR_MESSAGE);
                }
